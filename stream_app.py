...
scada_file = st.sidebar.file_uploader("Upload SCADA Data CSV", type=["csv"])
fault_file = st.sidebar.file_uploader("Upload Fault Data CSV", type=["csv"])

# Check if files are uploaded
if scada_file and fault_file:
    # Load data from uploaded CSV files
    df = load_data(scada_file)
    fault_df = load_data(fault_file)
    ...
    st.warning("Please upload both SCADA Data CSV and Fault Data CSV.")
